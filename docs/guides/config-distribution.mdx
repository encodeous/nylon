...
4. ### Configure Nodes
   ...
   that cadence. For HTTP repositories, Nylon reuses connections, honors
   freshness headers, and uses `ETag` or `Last-Modified` validators to avoid
   downloading an unchanged bundle.
